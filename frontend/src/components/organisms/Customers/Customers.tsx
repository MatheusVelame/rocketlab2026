                            ...
                            <tr key={c.id_consumidor} style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                                ...
                                <td style={{ padding: '24px', textAlign: 'center' }}>
                                    <button
                                        ...
                                        style={{ backgroundColor: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', color: '#6366f1', padding: '8px 16px', borderRadius: '12px', fontSize: '10px', fontWeight: '900', textTransform: 'uppercase', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px', transition: 'all 0.3s' }}
                                    >
